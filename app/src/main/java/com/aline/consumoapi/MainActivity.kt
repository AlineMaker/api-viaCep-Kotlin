...
import com.aline.consumoapi.service.RetrofitFactory
import com.aline.consumoapi.ui.theme.ConsumoAPITheme
...
// qualquer recurso wifi internet bluetoot vc vai em app manifests androidmaniefest.xml e  manifesta o uso do q vc vai usar
@Composable
...
//faz chamada para api e recebe uma promessa , call armazenar temporiamente a chamada q a gente esta fazendo
                    IconButton( onClick = {
